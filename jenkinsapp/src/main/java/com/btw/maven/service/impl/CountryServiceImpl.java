...
import com.btw.maven.service.CountryService;
...
/**
 * Service Implementation for managing {@link com.btw.maven.domain.Country}.
 */
@Service
@Transactional
    ...
    public Optional<Country> partialUpdate(Country country) {
        ...
        return countryRepository
            ...
            .map(existingCountry -> {
                ...
                if (country.getCounrtyAreaCode() != null) {
                    existingCountry.setCounrtyAreaCode(country.getCounrtyAreaCode());
                }
